[<Literal>]
let ikvm = @"..\packages\JavaTypeProvider.1.0.0\IKVM\bin\"

[<Literal>]
let itextpdf = @"..\JavaSources\itextpdf-5.4.4.jar"

[<Literal>]
let javaTest2 = @"..\JavaSources\javaTest2.jar"

[<Literal>]
let scalaTest1 = @"..\JavaSources\scalaTest1.jar"
